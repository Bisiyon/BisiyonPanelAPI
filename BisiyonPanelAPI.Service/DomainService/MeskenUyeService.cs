...
namespace BisiyonPanelAPI.Service
{
    public class MeskenUyeService : ServiceBase<MeskenUye>, IMeskenUyeService
    {
        ...
        private readonly UyeHareketService _uyeHareketService;
        public MeskenUyeService(IUnitOfWork unitOfWork, UyeHareketService uyeHareketService) : base(unitOfWork)
        {
